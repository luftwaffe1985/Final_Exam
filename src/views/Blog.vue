<template>
    ...
    <section class="post center">
        <div class="post__content">
            ...
            <div v-for="item in currentPostList" :key="item.id" class="post__subcontent-box">
    ...
    <section class="news center">
        <div class="news__content">
            ...
            <Pagination :totalNumberPaginationPages="setTotalNumberOfPages()" :currentPage="currentPage" :pageKey="pageKey"
