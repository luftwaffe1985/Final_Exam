                ...
                <div class="sidebar__content">
                    ...
                    <div class="sidebar__buttons-box">
                        <button v-for="button in buttons" :key="button.id" @click="changeArticle(button.id)" type="button"
                            :class="[
                                'sidebar__button',
                                button.id === buttonIsActive ? 'sidebar__button_active' : false,
                            ]">
                            {{ button.title }}
                        </button>
                    </div>
        ...
        return {
            ...
            currentArticle: [
                {
                    ...
                    src: require("@/assets/images/article-kitchen.png"),
                    alt: "kitchen",
                    ...
                    thirdsubtext:
                        "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
                    secondsrc: require("@/assets/images/article-kitchen2.png"),
            ...
            listOfArticles: [
                ...
                },
                {
                    ...
                    src: require("@/assets/images/bedroom_bd.png"),
                    alt: "bedroom",
                    date: "26 December,2022",
                    firstlink: "Interior",
                    secondlink: "Home",
                    ...
                    thirdsubtext:
                        "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
                    secondsrc: require("@/assets/images/bedroom_bd.png"),
                ...
                },
                {
                    ...
                    src: require("@/assets/images/building_bd.png"),
                    alt: "building",
                    date: "26 December,2022",
                    firstlink: "Interior",
                    secondlink: "Home",
                    ...
                    thirdsubtext:
                        "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
                    secondsrc: require("@/assets/images/building_bd.png"),
                ...
                },
                {
                    ...
                    src: require("@/assets/images/architecture_bd.png"),
                    alt: "architecture",
                    date: "26 December,2022",
                    firstlink: "Interior",
                    secondlink: "Home",
                    ...
                    thirdsubtext:
                        "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
                    secondsrc: require("@/assets/images/architecture_bd.png"),
                ...
                },
                {
                    ...
                    src: require("@/assets/images/kitchen_planning_bd.png"),
                    ...
                    thirdsubtext:
                        "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
                    secondsrc: require("@/assets/images/kitchen_planning_bd.png"),
        ...
        changeArticle(id) {
            ...
            this.listOfArticles.forEach((article) => {
                if (buttonId === article.id) {
                    ...
                    this.$router.push(
                        `/${this.pageKey}/${this.buttonIsActive}`
                    );
