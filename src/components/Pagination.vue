    ...
    <div class="pagination">
        <ul class="pagination__box">
            <li class="pagination__item">
                <router-link @click="onClickPreviousPage" :to="getPageLinkPrev"
                    :class="{ pagination__button_inactive: isInFirstPage }" class="pagination__button">
                    <svg class="pagination__button-svg" xmlns="http://www.w3.org/2000/svg" width="53" height="52"
            ...
            <li v-for="page in pages" class="pagination__item">
                <router-link @click="onClickPage(page)" :to="getPageLink"
                    :class="{ pagination__button_active: isPageActive(page) }" class="pagination__button" :disabled="page">
                    0{{ page }}
                </router-link>
            </li>
            <li class="pagination__item">
                <router-link @click="onClickNextPage" :to="getPageLinkNext"
                    :class="{ pagination__button_inactive: isInLastPage }" class="pagination__button">
